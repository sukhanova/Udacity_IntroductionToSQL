...
/*
Q: How many accounts spent less than 1,000 usd total across all orders?
A: 3
*/
SELECT a.id, a.name, SUM(o.total_amt_usd) total_spent
FROM accounts a
...
/*
Q: Which account has spent the most with us?
A: EOG Resources
*/
SELECT a.id, a.name, SUM(o.total_amt_usd) total_spent
FROM accounts a
...
/*
Q: Which account has spent the least with us?
A: Nike
*/
SELECT a.id, a.name, SUM(o.total_amt_usd) total_spent
FROM accounts a
...
/*
Q: Which accounts used facebook as a channel to contact customers more than 6 times?
A: 46
*/
...
/*
Q: Which account used facebook most as a channel?\
A: Gilead Sciences
*/
